...
class LanguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create langue" do
    assert_difference('Langue.count') do
      post langues_url, params: { langue: { description: @langue.description, nom: @langue.nom, note: @langue.note } }
    end
  ...
  test "should update langue" do
    patch langue_url(@langue), params: { langue: { description: @langue.description, nom: @langue.nom, note: @langue.note } }
